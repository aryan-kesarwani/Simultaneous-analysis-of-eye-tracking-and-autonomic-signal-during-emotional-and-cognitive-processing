...
%  09-19-16 duplicated from runica from eeglab under GPL and rand state initialization commented out. -jd
%  07-06-19 added ep_tictoc call. -jd
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if biasflag & extended
    while step < maxsteps, %%% ICA step = pass through all the data %%%%%%%%%
        theDuration=ep_tictoc;if isnan(theDuration);return;end;
